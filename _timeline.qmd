...
gantt
    ...
    design and run simulations :a2run, after a2multi, 4w
    ...
    configure and train RSNN models : a3train, after a3infra, 8w
    configure system ID and control methods :a3sysctrl, after a3train a2revise, 6w
    design and run experiments :a3expt, after a3sysctrl, 3w
    ...
    possible internship :intern, 2023-05-01, 120d
