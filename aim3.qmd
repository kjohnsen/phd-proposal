...
My hypothesis is that control quality will plateau with a number of actuators on or near the same level of magnitude as the latent factors used to describe the neural activity---that the per-neuron actuation limit will not be needed.
