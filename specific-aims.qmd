...
I will then use the simulation testbed of Aim 1 to explore control quality varies with recording, stimulation, and control parameters and the complexity and size of the system---thus giving researchers a tentative idea of the relative importance of each factor of CLOC.
