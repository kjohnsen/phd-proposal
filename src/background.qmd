...
This closed-loop control of neural activity offers exciting prospects of intervention in processes that are too fast or unpredictable to control manually or with pre-defined stimulation, such as sensory information processing, motor planning, and oscillatory activity. Unlike other forms of closed-loop control using environmental/stimulus input [@tafazoli20], behavioral output [@srinivasan18] or neurofeedback training [@prsa17; @eriksson22], the direct control of neural activity itself provides more opportunities for revealing the downstream effects of that activity. 

### Types of closed-loop control {#sec-cl-types}
Closed-loop control of neural activity can be implemented in an event-triggered sense [@krook-magnuson13; @witt13; @dutta19]---enabling the experimenter to respond to discrete events of interest, such as the arrival of a traveling wave [@davis20] or sharp wave ripple [@buzsaki15]---or in a feedback sense [@newman15; @bolus18; @bolus21; @zhang18], driving the system towards a target or along a trajectory.
...
These error-free control methods later saw further development and the introduction of optogenetic actuation.
