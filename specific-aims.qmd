...
However, the basic control theory methods previously used in conjuction with CLOC do not take actuator constraints into account and are thus inadequate for multi-actuator problems.
...
In this aim I will translate more sophisticated model-based feedback control algorithms to the  bidirectional CLOC setting and demonstrate the advantages both of CLOC and these algorithmic improvements.
